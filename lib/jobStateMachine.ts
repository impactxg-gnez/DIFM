...
const VALID_TRANSITIONS: Record<JobStatus, JobStatus[]> = {
  ...
  IN_PROGRESS: ['COMPLETED', 'MISMATCH_PENDING', 'PARTS_REQUIRED'],
  MISMATCH_PENDING: ['ASSIGNED', 'ON_SITE', 'IN_PROGRESS', 'REBOOK_REQUIRED'],
  REBOOK_REQUIRED: ['BOOKED'],
  SCOPE_MISMATCH: ['IN_PROGRESS', 'BOOKED', 'MISMATCH_PENDING', 'REBOOK_REQUIRED'], // Legacy support + transition to new flow
